...
//                Context.MODE_PRIVATE);
        ...
        exploreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (exploreToggleBtn.getText().equals("START")) {
                    showToast("Auto Movement/ImageRecog timer stop!");
                    robotStatusTextView.setText("Auto Move Stopped");
                    timerHandler.removeCallbacks(timerRunnableExplore);
                } else if (exploreToggleBtn.getText().equals("STOP")) {
//                    String msg = gridMap.getObstacles();
//                    MainActivity.printCoords(msg);
                    ((MainActivity) requireActivity()).getBluetoothService().write("Start Auto Move");
                    MainActivity.stopTimerFlag = false;
                    showToast("Auto Movement/ImageRecog timer start!");
                    robotStatusTextView.setText("Auto Move Started");
//                    System.out.println("Auto Move Started");
        ...
        fastestButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fastestToggleBtn.getText().equals("START")) {
...
//                        MainActivity.printMessage("STM|Start");
                        ((MainActivity) requireActivity()).getBluetoothService().write("Start Fastest Car");
//                        System.out.println("Fastest Car Started");
                    } catch (Exception e) {
